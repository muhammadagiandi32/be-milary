...
<body style="background-color:#f3f3f5;">
    <div
        ...
        Preview - Notification from Coded Mails </div>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width:150px;">
                                                                                    <img height="auto"
                                                                                        src="https://office-dev.aerospace.co.id/assets/images/logo/logo_dark.png"
                ...
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;padding:0 20px;text-align:center;">
                            <div
                                style="background:#49AEFC;background-color:#49AEFC;margin:0px auto;border-radius:4px;max-width:560px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="background:#49AEFC;background-color:#49AEFC;width:100%;border-radius:4px;">
                                    <tbody>
                                        <tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p class="date"
                                                                            ...
                                                                            DAEBAK</p>
                                                                        <h2
                                                                            style="margin: 0; font-size: 20px; font-weight: 300; line-height: 24px;">
                                                                            {{
                                                                            // dd($data)
                                                                            $name
                                                                            }}!</h2>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0;">
                                                                            Your daily bonus today 20-01-2023 is Rp
                                                                            {{ $total_bonus }}. It’s such a great
                                                                            pleasure to
                                                                            work with you! Let’s work harder & conquer
                                                                            the world with AEROSPACE! </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        email and we would be more than happy to reply.
                                                                        :)</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    © {{ date('Y') }} PT. Aerospace Indonesia Investama, All rights
                                                    reserved <br /> Email: <a class="footer-link" href="#"
                                                        style="color: #2e58ff; text-decoration: none;">customercare.aerospace@gmail.com</a>
                                                    <br /> Web: <a class="footer-link" href="#"
                                                        style="color: #2e58ff; text-decoration: none;">www.aerospace.co.id</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
